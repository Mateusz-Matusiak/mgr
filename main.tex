...
% Rozdziały
\input{rozdzialy/1_wstep}
\input{rozdzialy/2_skolioza}
% \input{rozdzialy/2_technologie}
% \input{rozdzialy/3_narzedzia}
% \input{rozdzialy/4_architektura_i_strukura}
% \input{rozdzialy/5_opis}
% \input{rozdzialy/6_podsumowanie}
